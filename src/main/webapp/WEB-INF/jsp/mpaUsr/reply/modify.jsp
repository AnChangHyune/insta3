				...
				<div class="container mx-auto">
					<form method="POST" action="doModify"
						...
						<div class="form-control mt-5">
							<label class="label"> 게시글 번호 </label>
							<div class="text-light text-sm text-gray-400">${reply.relId}</div>
						</div>

						<div class="form-control">
							<label class="label"> 게시글 제목 </label>
							<div class="text-light text-sm text-gray-400">${title}</div>
						</div>

						<div class="form-control">
							<label class="label"> 내용 </label>
							<textarea class="textarea textarea-bordered w-full h-24"
								placeholder="내용을 입력해주세요." name="body" maxlength="2000">${reply.body}</textarea>
						</div>
